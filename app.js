        ...
        for (j = 1; j < width; j++) {
            ...
            if (
                ...
                (countDiagonal(i, j, 0, oponent_player) == 3 &&
                    countDiagonal(i, j, 0, 0) == 1) ||
                (countDiagonal(i, j, 1, oponent_player) == 3 && countDiagonal(i, j, 1, 0) == 1)
            ) {
                score -= 1000;
            }
            ...
            if (
                ...
                (countDiagonal(i, j, 0, oponent_player) == 2 &&
                    countDiagonal(i, j, 0, 0) == 2) ||
                (countDiagonal(i, j, 1, oponent_player) == 2 && countDiagonal(i, j, 1, 0) == 2)
            ) {
                score -= 10;
            }
            ...
            if (
                ...
                (countDiagonal(i, j, 0, oponent_player) == 1 &&
                    countDiagonal(i, j, 0, 0) == 3) ||
                (countDiagonal(i, j, 1, oponent_player) == 1 && countDiagonal(i, j, 1, 0) == 3)
            ) {
                score -= 1;
            }
        }
    ...
    if (is_maximizing) {
        ...
        for (let j = 0; j < width; j++) {
            ...
            if (tempI < height && tempI > -1) {
                ...
                let score = minimax(board, depth - 1, false, number_of_moves + 1, alpha, beta);
        ...
        for (let j = 0; j < width; j++) {
            ...
            if (tempI < height && tempI > -1) {
                ...
                let score = minimax(board, depth - 1, true, number_of_moves + 1, alpha, beta);
